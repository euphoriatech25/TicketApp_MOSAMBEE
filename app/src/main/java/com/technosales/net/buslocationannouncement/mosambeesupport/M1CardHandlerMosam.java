...
public class M1CardHandlerMosam {
    private static final String TAG = "M1CardHandlerTest";

//    public static void test_m1card(final DeviceServiceEngine mSDKManager) {
//        new SearchCardOrCardReader(mSDKManager).searchRFCard(new String[]{IccCardType.M1CARD}, new OnSearchListener() {
//            @Override
...
//    }
    ...
    private static void m1card(DeviceServiceEngine engine) {
        try {
