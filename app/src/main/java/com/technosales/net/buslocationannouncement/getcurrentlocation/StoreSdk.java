...
import com.pax.market.android.app.sdk.ParamApiStrategy;
...
public class StoreSdk {
    ...
    private static volatile com.pax.market.android.app.sdk.StoreSdk instance;
    ...
    public static com.pax.market.android.app.sdk.StoreSdk getInstance() {
        if (instance == null) {
            synchronized (com.pax.market.android.app.sdk.StoreSdk.class) {
                if (instance == null) {
                    instance = new com.pax.market.android.app.sdk.StoreSdk();
                }
            }
        }
        return instance;
...
//            logger.debug("acquireSemaphore api release acquire 2");
     ...
     * @param inquirer
     */
    public void initInquirer(final com.pax.market.android.app.sdk.StoreSdk.Inquirer inquirer) {
...
//            logger.error("Store sdk not initialized");
    ...
    public interface LocationCallBack {
        void onLocationRetured(com.pax.market.android.app.sdk.dto.LocationInfo locationInfo);
    }
     ...
     */
    public void startLocate(Context context, com.pax.market.android.app.sdk.LocationService.LocationCallback locationCallback) {
        com.pax.market.android.app.sdk.dto.LocationInfo locationInfo = new LocationInfo();
        ...
        if (cursor == null) {
            com.pax.market.android.app.sdk.LocationService.setCallback(locationCallback);
